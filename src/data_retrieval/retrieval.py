...
from models.dtos import PromptType
...
class ConversationalRAG:
    ...
    def __init__(self, session_id: Optional[str], retriever=None):
        try:
            ...
            raise AssistIQAppException("Initialization error in ConversationalRAG", sys)
    ...
    def load_retriever_from_faiss(
        ...
        try:
            ...
            raise AssistIQAppException("Loading error in ConversationalRAG", sys)

    def invoke(self, user_input: str, chat_history: Optional[List[BaseMessage]] = None) -> str:
        """Invoke the LCEL pipeline."""
        try:
            if self.chain is None:
                raise AssistIQAppException(
            ...
            raise AssistIQAppException("Invocation error in ConversationalRAG", sys)
    ...
    def _load_llm(self):
        try:
            ...
            raise AssistIQAppException("LLM loading error in ConversationalRAG", sys)
    ...
    def _build_lcel_chain(self):
        try:
            if self.retriever is None:
                raise AssistIQAppException("No retriever set before building chain", sys)
            ...
            raise AssistIQAppException("Failed to build LCEL chain", sys)